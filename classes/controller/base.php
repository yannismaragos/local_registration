...
class base {
    ...
    protected function display_header(): void {
        ...
        // Strings.
        $titlestr = get_string('pluginname', 'local_registration');
        ...
        if ($title != get_string('pluginname', 'local_registration')) {
            $PAGE->navbar->add($title);
        }

        if ($node = $PAGE->settingsnav->find('local_registration', \navigation_node::TYPE_SETTING)) {
            $node->make_active();
        }
    ...
    protected function get_title(): string {
        ...
        return get_string($this->action . $this->mode, 'local_registration');
    }
    ...
    protected function get_explanatory_description(): ?string {
        $text = null;
        if ($this->action == 'base') {
            $text = get_string('basedescription', 'local_registration');
        }
