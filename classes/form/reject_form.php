...
/**
 * This file contains the form for handling the 'reject' action for the users table.
 *
...
/**
 * The form for handling the 'reject' action for the users table.
 *
 * @package     local_registration
 * @copyright   2023 onwards WIDE Services {@link https://www.wideservices.gr}
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reject_form extends dynamic_form {
    ...
    public function definition(): void {
        ...
        $mform->addElement(
            'textarea',
            'reason',
            get_string('modal:rejectreason', 'local_registration'),
        ...
        $mform->addHelpButton('reason', 'modal:rejectreason', 'local_registration');
    }
